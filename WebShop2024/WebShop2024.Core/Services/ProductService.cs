...
namespace WebShop2024.Core.Services
{
        ...
        public class ProductService : IProductService
        {
            ...
            {
                products = products
                    .Where(x => x.Category.CategoryName.ToLower().Contains(searchStringCategoryName.ToLower()) &&
            ...
            {
                products = products
                    .Where(x => x.Brand.BrandName.ToLower().Contains(searchStringBrandName.ToLower()))
                    .ToList();
            }
